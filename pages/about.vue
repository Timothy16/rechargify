...
useHead({
  ...
  meta: [
    ...
    {
      property: 'og:url',
      content: 'https://Rechargify.com/about'
    },
    {
      property: 'og:title',
    ...
    {
      property: 'og:image',
      content: 'https://Rechargify.com/og-about-image.jpg'
    },
    // Twitter
    {
      name: 'twitter:card',
    ...
    {
      name: 'twitter:image',
      content: 'https://Rechargify.com/twitter-about-image.jpg'
    },
    // Additional SEO tags
    {
      name: 'robots',
  ...
  link: [
    {
      rel: 'canonical',
      href: 'https://Rechargify.com/about'
    }
  ]
})
